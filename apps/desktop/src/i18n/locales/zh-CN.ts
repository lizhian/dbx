...
export default withEnglishFallback({
  ...
  fileManager: {
    ...
    folderName: "文件夹名称",
    create: "新建",
    createDirectorySucceeded: "文件夹已新建",
    download: "下载",
    downloadList: "下载列表",
    downloadStatus: "下载状态",
    downloading: "下载中",
    noDownloads: "当前连接暂无下载记录",
    downloadWaiting: "等待确认覆盖",
    downloadCompleted: "已完成",
    downloadFailed: "下载失败",
    downloadCancelled: "下载已取消",
    openDownloadedFile: "打开文件",
    openDownloadFolder: "打开文件夹",
    openDownloadedFileFailed: "打开文件失败：{message}",
    openDownloadFolderFailed: "打开文件夹失败：{message}",
    localFile: "本地文件",
    remotePath: "远程路径",
