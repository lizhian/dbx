...
export default withEnglishFallback({
  ...
  fileManager: {
    ...
    selectDownload: "保存下载文件",
    upload: "上传",
    download: "下载",
    localFile: "本地文件",
    remotePath: "远程路径",
    transferring: "文件操作进行中",
    uploadSucceeded: "已上传 {size}",
    downloadSucceeded: "已下载 {size}",
    replaceTitle: "替换现有文件？",
    replaceMessage: "目标已存在，是否使用当前文件替换？",
    replace: "替换",
    deleteEntryTitle: "删除文件或文件夹？",
    deleteEntryMessage: "删除“{name}”？仅支持删除空文件夹。",
    deleteSucceeded: "文件或文件夹已删除",
    copy: "复制",
    rename: "重命名或移动",
    expandFolder: "展开文件夹",
    ...
    copySucceeded: "文件已复制",
    renameSucceeded: "文件或文件夹已重命名或移动",
    streamRelayNotice: "本次复制通过当前设备进行有界流式中继。",
    nonAtomicRenameNotice: "本次重命名不是原子操作：DBX 会先复制文件，再删除源文件；删除失败时两个文件都会保留。",
    directoryRenameNotice: "文件夹移动不是原子操作：DBX 会以有界流式方式复制各项，再删除源目录树；任一阶段失败都会报告部分成功。",
    bestEffortNoClobberNotice: "此连接上的目标存在性检查仅提供 best-effort 保证。",
    kind: {
      file: "文件",
      directory: "文件夹",
      unknown: "未知",
    ...
    test: "测试连接",
    testSucceeded: "连接成功",
    connectionSaved: "文件连接已保存",
    connectionDeleted: "文件连接已删除",
    secretPreserved: "留空以保留已保存的密码",
    clearSavedPassword: "清除已保存的密码",
    ftpWarning: "FTP 会以明文传输凭据和文件内容，请仅在可信网络中使用。",
    authentication: "认证方式",
    sshConfig: "SSH config",
    sshAgent: "SSH agent",
    privateKey: "私钥文件",
    selectPrivateKey: "选择私钥文件",
    privateKeyPreserved: "已保存的私钥文件保持不变",
    clearSavedPrivateKey: "清除已保存的私钥文件",
    sftpAuthenticationNotice: "SFTP 在 macOS 和 Linux 上使用系统 OpenSSH，不支持密码认证和 Windows。",
    sftpWindowsUnsupported: "Windows 不支持 SFTP，同时也不支持密码认证。",
    region: "区域",
    bucket: "存储桶",
    accessKey: "Access key",
    secretKey: "Secret key",
    sessionToken: "Session token",
    pathStyle: "使用 path-style URL",
    optional: "可选",
    clearSavedAccessKey: "清除已保存的 access key",
    clearSavedSecretKey: "清除已保存的 secret key",
    clearSavedSessionToken: "清除已保存的 session token",
    basicAuthentication: "Basic",
    bearerAuthentication: "Bearer token",
    bearerToken: "Bearer token",
    clearSavedBearerToken: "清除已保存的 bearer token",
    implementation: "实现",
    useDelegationToken: "使用 delegation token",
    simpleUser: "Simple user",
    delegationToken: "Delegation token",
    clearSavedDelegationToken: "清除已保存的 delegation token",
    nameNodeUri: "NameNode URI",
    hadoopConfigDirectory: "Hadoop 配置目录",
    selectHadoopConfigDirectory: "选择 Hadoop 配置目录",
    deleteConnectionTitle: "删除文件连接",
    deleteConnectionMessage: "删除“{name}”及其已保存凭据？",
  },
  updates: {
    title: "更新",
    check: "检查更新",
