...
export default withEnglishFallback({
  ...
  fileManager: {
    title: "文件管理",
    add: "新建文件连接",
    emptyConnections: "暂无文件连接",
    emptyDirectory: "根目录为空",
    name: "名称",
    connectionType: "连接类型",
    endpoint: "服务地址",
    region: "区域",
    ...
    virtualHostStyle: "使用虚拟主机寻址",
    anonymous: "使用匿名访问",
    clearS3Credentials: "删除已保存的 S3 凭据",
    root: "根目录",
    username: "用户名",
    password: "密码",
    keepPassword: "留空以保留已保存的密码",
    clearPassword: "删除已保存的密码",
    ftpSecurity: "FTP 是未加密协议。用户名、密码和文件内容会以明文在网络上传输。",
    s3Security: "S3 凭据与连接配置分开存储。请使用 HTTPS 服务地址加密传输中的凭据和文件内容。",
    webdavSecurity: "WebDAV 凭据与连接配置分开存储。请使用 HTTPS，HTTP 会暴露凭据和文件内容。",
    sftpSecurity: "SFTP 会严格校验主机密钥。认证可使用默认 SSH 配置、SSH Agent，或与连接配置分开存储的内联私钥。不支持仅密码认证。",
    sftpUnsupported: "当前平台不支持",
    hdfsSecurity: "HDFS Native 使用纯 Rust 客户端、Simple 认证和单个显式 NameNode。Kerberos、HA、ViewFS 和多 NameNode 配置会被拒绝。",
    webhdfsSecurity: "WebHDFS 委派令牌与连接配置分开存储。DataNode 重定向仅允许精确白名单来源；请使用 HTTPS 和可信 CA。",
    implementation: "实现方式",
    native: "Native",
    nameNodeUri: "NameNode URI",
    hadoopConfigDirectory: "Hadoop 配置目录",
    hdfsOptions: "允许的 Hadoop 选项",
    hdfsOptionsHint: "每行一个 key=value",
    hdfsUseUserEnvironment: "使用进程中已有的 HADOOP_USER_NAME 环境值",
    webhdfsCopyRisk: "WebHDFS 复制通过 DBX 有界分块中继，验证操作专属临时文件后使用 REST RENAME 发布。不会通过删除已有目标来实现替换。",
    webhdfsRenameRisk: "WebHDFS 重命名使用 REST RENAME 和尽力避免覆盖的预检，无法安全替换已有目标。",
    webhdfsUploadRiskConfirm: "使用有界 WebHDFS 流上传到“{path}”并通过 REST RENAME 发布吗？",
    webhdfsSimple: "Simple 用户",
    webhdfsDelegation: "委派令牌",
    webhdfsDelegationToken: "委派令牌",
    clearWebhdfsCredentials: "删除已保存的委派令牌",
    webhdfsDataNodeOrigins: "允许的 DataNode 来源（每行一个）",
    webhdfsHostnameMapping: "DataNode 主机名映射（host=address）",
    webhdfsTlsCa: "TLS CA 证书路径",
    webhdfsProxy: "代理 URL",
    webhdfsProxyBypass: "代理绕过列表",
    webhdfsConnectTimeout: "连接超时（秒）",
    webhdfsControlTimeout: "控制请求超时（秒）",
    webhdfsIdleTimeout: "流空闲超时（秒）",
    webhdfsChunkSize: "中继分块大小（MiB）",
    webhdfsPermission: "创建权限",
    webhdfsReplication: "副本数",
    webhdfsBlockSize: "块大小（字节）",
    webhdfsBufferSize: "缓冲区大小（字节）",
    webhdfsDisableListBatch: "禁用批量目录列表",
    sshConfig: "默认 SSH 配置",
    sshAgent: "SSH Agent",
    sshPrivateKey: "内联私钥",
    privateKeyMaterial: "私钥内容",
    privateKeyPassphrase: "私钥口令",
    keepPrivateKey: "留空以保留已保存的私钥和口令",
    clearSftpCredentials: "删除已保存的 SFTP 私钥凭据",
    authentication: "认证方式",
    authNone: "无认证",
    authBasic: "Basic 用户名和密码",
    authBearer: "Bearer Token",
    bearerToken: "Bearer Token",
    clearWebdavCredentials: "删除已保存的 WebDAV 凭据",
    test: "测试连接",
    edit: "编辑连接",
    delete: "删除连接",
    deleteConfirm: "删除该文件连接及其已保存凭据？",
    createDirectory: "创建目录",
    directoryPath: "目录路径",
    directoryPathHint: "相对于配置根目录，例如 reports/2026",
    deleteEntry: "删除",
    deleteEntryConfirm: "删除“{name}”？只能删除文件或空目录。",
    operationComplete: "文件操作已完成",
    loadError: "加载文件连接失败",
    testSuccess: "连接测试通过",
    refresh: "刷新",
    stageConfiguration: "配置",
    stageAuthentication: "认证",
    stageHostKey: "主机密钥",
    stageNameNode: "NameNode",
    stageNameNodeRpc: "NameNode RPC",
    stageDataNode: "DataNode",
    stageDataNodeWrite: "DataNode 写入",
    stageDataNodeRead: "DataNode 读取",
    type: "类型",
    size: "大小",
    modified: "修改时间",
    loadMore: "加载更多",
    cursorExpired: "当前目录浏览会话已过期，请刷新后继续。",
    metadata: "元数据",
    contentType: "内容类型",
    contentEncoding: "编码",
    ...
    contentMd5: "内容 MD5",
    version: "版本",
    loadedCount: "已加载 {count} 项",
    actions: "操作",
    download: "下载",
    upload: "上传文件",
    uploadRiskConfirm: "是否使用 FTP 尽力避免覆盖策略上传到“{path}”？FTP 无法保证最终存在性检查与重命名的原子性，外部写入者可能与本次上传竞争。DBX 不会主动替换已检测到的目标。",
    s3UploadRiskConfirm: "上传到“{path}”吗？S3 使用有界分片上传并通过服务端复制发布；若服务不支持条件复制，避免覆盖仅为尽力保证。",
    copy: "复制",
    rename: "重命名",
    destinationPath: "目标路径",
    copyRenameRisk: "FTP 使用尽力避免覆盖策略。最终存在性检查与发布不是原子操作，外部写入者仍可能与本次操作竞争。",
    s3CopyRisk: "S3 使用服务端 CopyObject，文件内容不会经由 DBX 中继。若服务不支持条件复制，避免覆盖仅为尽力保证。",
    s3RenameRisk: "S3 重命名是非原子的服务端复制后删除源对象；删除源对象失败时会持久化部分成功状态。",
    webdavCopyRisk: "WebDAV COPY 在服务端执行，文件内容不会经由 DBX 中继。由于后端始终发送 Overwrite: T，避免覆盖仅为尽力保证。",
    webdavRenameRisk: "WebDAV 重命名使用服务端原生 MOVE。避免覆盖仅为尽力保证，外部写入者仍可能与目标预检竞争。",
    sftpUploadRiskConfirm: "上传到“{path}”吗？SFTP 使用原生重命名发布操作专属临时文件；外部写入者可能与目标预检竞争，因此避免覆盖仅为尽力保证。",
    sftpCopyRisk: "SFTP 复制使用有界内存经 DBX 中继文件内容，再通过原生重命名发布；避免覆盖仅为尽力保证。",
    sftpRenameRisk: "SFTP 重命名使用服务端原生重命名；外部写入者可能与目标预检竞争，因此避免覆盖仅为尽力保证。",
    hdfsUploadRiskConfirm: "上传到“{path}”吗？HDFS 使用原生 rename2 发布操作专属临时文件；外部写入者可能与目标预检竞争，因此避免覆盖仅为尽力保证。",
    hdfsCopyRisk: "HDFS 复制通过 DBX 以最大 4 MiB 的有界应用层分块中继文件内容，再通过原生 rename2 发布；避免覆盖仅为尽力保证。",
    hdfsRenameRisk: "HDFS 重命名使用 Hadoop 原生 rename2。替换已有目标必须显式确认；产品层面的避免覆盖仍为尽力保证。",
    replaceDestination: "目标存在时替换",
    replaceConfirm: "确定替换“{path}”吗？这会明确允许覆盖已有远程数据。",
    retrySourceDelete: "校验指纹后重试删除源文件",
