export default {
  ...
  fileManager: {
    ...
    security: "FTP is unencrypted. Usernames, passwords, and file contents travel over the network in plaintext.",
    test: "Test connection",
    edit: "Edit connection",
    delete: "Delete connection",
    deleteConfirm: "Delete this FTP connection and its saved password?",
