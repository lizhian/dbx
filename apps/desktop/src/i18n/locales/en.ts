export default {
  ...
  fileManager: {
    ...
    connectionNotFound: "File connection no longer exists",
    name: "Name",
    protocol: "Protocol",
    endpoint: "Endpoint",
    port: "Port",
    ...
    selectUpload: "Select a file to upload",
    selectDownload: "Save downloaded file",
    upload: "Upload",
    download: "Download",
    localFile: "Local file",
    remotePath: "Remote path",
    transferring: "File operation in progress",
    uploadSucceeded: "Uploaded {size}",
    downloadSucceeded: "Downloaded {size}",
    replaceTitle: "Replace existing file?",
    replaceMessage: "The destination already exists. Replace it with this file?",
    replace: "Replace",
    deleteEntryTitle: "Delete file or folder?",
    deleteEntryMessage: "Delete “{name}”? Only empty folders can be deleted.",
    deleteSucceeded: "File or folder deleted",
    copy: "Copy",
    ...
    copySucceeded: "File copied",
    renameSucceeded: "File or folder renamed or moved",
    streamRelayNotice: "This copy uses your device as a bounded streaming relay.",
    nonAtomicRenameNotice: "This rename is non-atomic: DBX copies the file, then deletes the source. If deletion fails, both files remain.",
    directoryRenameNotice: "Folder moves are non-atomic: DBX copies entries with bounded streaming, then removes the source tree. Partial results are reported if either phase fails.",
    bestEffortNoClobberNotice: "The destination existence check is best-effort on this connection.",
    kind: {
      file: "File",
      directory: "Folder",
      unknown: "Unknown",
    ...
    connectionSaved: "File connection saved",
    connectionDeleted: "File connection deleted",
    secretPreserved: "Leave blank to keep the saved password",
    clearSavedPassword: "Clear the saved password",
    ftpWarning: "FTP sends credentials and file contents without encryption. Use it only on a trusted network.",
    authentication: "Authentication",
    sshConfig: "SSH config",
    sshAgent: "SSH agent",
    privateKey: "Private key file",
    selectPrivateKey: "Select private key file",
    privateKeyPreserved: "The saved private key file remains unchanged",
    clearSavedPrivateKey: "Clear the saved private key file",
    sftpAuthenticationNotice: "SFTP uses system OpenSSH on macOS and Linux. Password authentication and Windows are not supported.",
    sftpWindowsUnsupported: "SFTP is not supported on Windows. Password authentication is also not supported.",
    region: "Region",
    bucket: "Bucket",
    ...
    optional: "Optional",
    clearSavedAccessKey: "Clear the saved access key",
    clearSavedSecretKey: "Clear the saved secret key",
    clearSavedSessionToken: "Clear the saved session token",
    basicAuthentication: "Basic",
    bearerAuthentication: "Bearer token",
    bearerToken: "Bearer token",
    clearSavedBearerToken: "Clear the saved bearer token",
    implementation: "Implementation",
    useDelegationToken: "Use delegation token",
    simpleUser: "Simple user",
    delegationToken: "Delegation token",
    clearSavedDelegationToken: "Clear the saved delegation token",
    nameNodeUri: "NameNode URI",
    hadoopConfigDirectory: "Hadoop config directory",
    selectHadoopConfigDirectory: "Select Hadoop config directory",
    deleteConnectionTitle: "Delete file connection",
    deleteConnectionMessage: "Delete “{name}” and its saved credentials?",
  },
  updates: {
    title: "Updates",
