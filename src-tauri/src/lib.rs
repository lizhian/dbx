...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::file_manager::list_file_entries,
            ...
            commands::file_transfer::start_file_copy,
            commands::file_transfer::start_file_rename,
            ...
            commands::file_transfer::retry_file_rename_source_delete,
